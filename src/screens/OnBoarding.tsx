        ...
        <div className="flex flex-col justify-center items-center gap-8 mt-20 ">
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="flex gap-3 items-center justify-between">
              <Card
                className={`w-full bg-surface rounded-xl flex flex-col items-center py-6 px-2 ${formData.sex === "man" ? "border border-[#75d253] transition-all" : "border border-border"} gap-2`}
              ...
              <Card
                className={`w-full bg-surface rounded-xl flex flex-col items-center py-6 px-2 ${formData.sex === "woman" ? "border border-[#75d253] transition-all" : "border border-border"} gap-2`}
        ...
        <div className="flex flex-col justify-center items-center gap-8 mt-20 ">
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="flex flex-col gap-2">
              {targets.map((item) => {
                ...
                return (
                  <Card
                    className={`w-full bg-surface rounded-xl py-3 px-5 flex items-center ${formData.target === item.target ? "border border-[#75d253] transition-all" : "border border-border"} gap-4 `}
                    onClick={() =>
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="flex flex-col gap-2">
              {activities.map((item) => (
                <Card
                  className={`w-full bg-surface rounded-xl py-3 px-5 flex justify-between items-center ${formData.activity === item.activity ? "border border-[#75d253] transition-all" : "border border-border"}`}
                  onClick={() =>
                    setFormData((prev) => ({
                      ...prev,
